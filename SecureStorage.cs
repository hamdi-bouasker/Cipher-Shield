...
namespace CipherShield
{
    public static class SecureStorage
    {
        ...
        {
            string filePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "Cipher Shield Pro", "Master-Password.dat");
        ...
        {
            string filePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "Cipher Shield Pro", "Files-Encryption-Password.pwd");
            byte[] encryptedData = File.ReadAllBytes(filePath);
            return DecryptWithDPAPI(encryptedData);
        }
